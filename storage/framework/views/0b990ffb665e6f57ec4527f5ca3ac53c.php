...
<div class="container my-5">
    ...
    <div id="product-list" class="row g-4">
        <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div style="margin-left: 5%" class="modal fade" id="productModal<?php echo e($producto->id); ?>" tabindex="-1"
                            ...
                            <div id="mainInfo<?php echo e($producto->id); ?>" class="contenedorInfo">
                                ...
                                <div class="cnt" style="width: 100%">
                                    <div class="product-info-container">
                                        ...
                                        <p><?php echo e($producto->codigo); ?></p>
                                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php if(count($configs) > 0): ?>
                                                        <?php $__currentLoopData = $configs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $config): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if(!empty($config)): ?>
                                                                <tr>
                                                                    <td class="text-center"><?php echo e($config); ?>
...
</html><?php /**PATH /home/u984597834/domains/solutronic.com.ar/resources/views/productos.blade.php ENDPATH**/ ?>