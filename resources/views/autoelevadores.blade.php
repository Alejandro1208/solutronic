...
<select name="filter" id="filter" class="form-control">
    ...
    <option value="{{ route('productos.index', ['filter' => 'Lamparas Electronica']) }}">&nbsp;&nbsp;Lámparas electrónica</option>
    <option value="{{ route('productos.index', ['filter' => 'Medidores de bateria']) }}">&nbsp;&nbsp;Medidores de batería</option>
    ...
    <option value="{{ route('productos.index', ['filter' => 'Portatil']) }}">&nbsp;&nbsp;Portátil</option>
    <option value="{{ route('productos.index', ['filter' => 'Reflectores']) }}">&nbsp;&nbsp;Reflectores</option>
    <option value="{{ route('productos.index', ['filter' => 'Balizas']) }}"style="color: #8C9094;">&nbsp;&nbsp;Autoelevadores</option>
    ...
    <option value="{{ route('productos.index', ['filter' => 'Energias Alternativas']) }}" disabled>Energías Alternativas</option>
    <option value="{{ route('productos.index', ['filter' => 'iluminacion']) }}">&nbsp;&nbsp;Iluminación</option>
...
<div id="product-list" class="row g-4"> 
            @foreach($productos as $producto)
                ...
                <div class="card h-100" style="{{ $producto->id != 1 ? 'display: none;' : '' }}">
